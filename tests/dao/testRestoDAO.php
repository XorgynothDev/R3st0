...
<html>
    ...
    <body>
        ...
        try {
            ...
            ?>
            <h3>4- getAllByTypesCuisine</h3>
            <p>Filtrage des restaurants sur les types de cuisine 3 (orientale) et 6 (vegan)</p>
            <?php
            $lesRestos = RestoDAO::getAllByTypesCuisine(array(3, 6));
            var_dump($lesRestos);
